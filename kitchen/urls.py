...
from kitchen.views import index, DishTypeListView, DishListView, DishDetailView, CookListView, CookDetailView, \
    ...
    DishDeleteView, CookCreateView, CookUpdateView, CookDeleteView, about, toggle_assign_to_dish
...
urlpatterns = [
    ...
    path("dishes/<int:pk>/toggle-assing/", toggle_assign_to_dish, name="toggle-dish-assign"),
